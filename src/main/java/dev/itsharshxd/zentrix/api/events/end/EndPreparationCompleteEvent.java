...
public final class EndPreparationCompleteEvent extends ZentrixGameEvent {
    private static final HandlerList HANDLERS = new HandlerList();
    private final boolean successful;
    private final String failureMessage;
    public EndPreparationCompleteEvent(@NotNull ZentrixGame game, boolean successful, String failureMessage) {
