 ...
 *   <li>{@link ScenarioService} - Scenario registration, selection, voting and overrides (since 1.6.0)</li>
 *   <li>{@link dev.itsharshxd.zentrix.api.identity.IdentityService} - Packet-level player identity masking (since 1.6.0)</li>
 *   <li>{@link dev.itsharshxd.zentrix.api.elimination.EliminationService} - Deathless eliminations (since 1.6.0)</li>
 *   <li>{@link dev.itsharshxd.zentrix.api.world.SkyDropService} - Airborne player insertion and glider deployment (since 1.6.0)</li>
 * </ul>
 *
 * @author ItsHarshXD
 * @since 1.0.0
...
public interface ZentrixAPI {
    ...
    default ScenarioService getScenarioService() {
        throw new UnsupportedOperationException("ScenarioService requires Zentrix API 1.6.0");
    }
    ...
    default dev.itsharshxd.zentrix.api.identity.IdentityService getIdentityService() {
        throw new UnsupportedOperationException("IdentityService requires Zentrix API 1.6.0");
    }
    ...
    default dev.itsharshxd.zentrix.api.elimination.EliminationService getEliminationService() {
        throw new UnsupportedOperationException("EliminationService requires Zentrix API 1.6.0");
    }
    ...
    default dev.itsharshxd.zentrix.api.world.SkyDropService getSkyDropService() {
        throw new UnsupportedOperationException("SkyDropService requires Zentrix API 1.6.0");
    }
}
