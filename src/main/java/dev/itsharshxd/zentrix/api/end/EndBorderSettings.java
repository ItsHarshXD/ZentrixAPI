...
/** Optional border changes for an End access toggle. Target radius {@code 0} preserves size. */
public final class EndBorderSettings {
    ...
    public EndBorderSettings(Boolean shrink, Double targetRadius, Integer durationSeconds,
